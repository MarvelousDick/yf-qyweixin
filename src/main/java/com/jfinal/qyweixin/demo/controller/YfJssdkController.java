...
import com.jfinal.qyweixin.demo.interceptor.QrScanInterceptor;
 ...
 */
public class YfJssdkController extends ApiController {
...
//        ac.setCorpId(PropKit.get("corpId"));
        ...
        ac.setCorpId("ww086ef14b9328f027");
        ac.setAgentId("1000004");
    ...
    public void index() {
        ...
        //Url需要修改
//        url="http://ethermorgan.s1.natapp.cc/yfjssd";
...
//    @Before(QrScanInterceptor.class)
//    public void scan(){
//        render("share.jsp");
//    }
